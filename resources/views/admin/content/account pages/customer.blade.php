...
<main class="main-content position-relative border-radius-lg ">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <p class="float-end">
                            <a href="#addcustomer" class="btn btn-light">Create</a>
                            <h6>Customer</h6>
                        </p>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/admin/customer/delete/{{ $item->id }}" onclick="return confirm('Are you sure?')" class=" text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
    ...
    <div class="card shadow-lg mx-4" id="addcustomer">
        <div class="card-header">
            <h5>Add Data Customer</h5>
        </div>
